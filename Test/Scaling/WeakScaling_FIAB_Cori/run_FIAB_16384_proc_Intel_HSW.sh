...
#SBATCH -q regular
#SBATCH -A m2860
#SBATCH -J FIAB_16384_proc_Intel_HSW
#SBATCH -t 00:15:00
#SBATCH -L SCRATCH
#SBATCH -o FIAB_16384_proc_Intel_HSW.%j.out
...
sbcast --compress=lz4 ./${INPUTS} /tmp/${INPUTS}
srun -n 16384 -c 2 --cpu-bind=cores /tmp/${EXE} /tmp/${INPUTS} ${EXTRA}
