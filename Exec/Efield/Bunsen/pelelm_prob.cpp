...
namespace ProbParm
{
   ...
   AMREX_GPU_DEVICE_MANAGED  amrex::Real Vcoflow = 0.0;
   AMREX_GPU_DEVICE_MANAGED  amrex::Real slot_width = 0.0;
   AMREX_GPU_DEVICE_MANAGED  amrex::Real splitx = 0.0;
   AMREX_GPU_DEVICE_MANAGED  amrex::Real phiV_lox = 0.0;
   AMREX_GPU_DEVICE_MANAGED  amrex::Real phiV_hix = 0.0;
...
extern "C" {
                         ...
                         const amrex_real* probhi)
    {
        ...
        pp.query("Vcoflow", ProbParm::Vcoflow);
        pp.query("slot_width", ProbParm::slot_width);
        ...
        ProbParm::splitx = problo[0] + 0.5 * (probhi[0] - problo[0]);

        read_pmf(ProbParm::pmf_datafile);

        pp.query("PhiV_x_lo", ProbParm::phiV_lox);
        pp.query("PhiV_x_hi", ProbParm::phiV_hix);
    }
}
