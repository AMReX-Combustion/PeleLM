...
def calc_sl(args):
    ...
    if ( args.compare_AC and os.path.isfile("AC_History") ):
        ...
        os.system("echo Ref. AC Consumption > FlameSpeedsCompa_X.dat")
        os.system("echo {} {} {} >> FlameSpeedsCompa_X.dat".format(Sl_ref, Sl_AC, Sl))
        os.system("echo 1.0 {} {} >> FlameSpeedsCompa_X.dat".format(diffSlAC,diffSl))
