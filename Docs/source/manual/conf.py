# -*- coding: utf-8 -*-
#
# PeleLM documentation build configuration file, created by
# sphinx-quickstart
#
...
#breathe_projects = {"PeleLM": "../doxygen_output/xml/"}
#breathe_default_project = "PeleLM"
...
latex_documents = [
    (master_doc, 'PeleLM.tex', u'PeleLM Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'pelec', u'PeleLM Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PeleLM', u'PeleLM Documentation',
     author, 'PeleLM', 'One line description of project.',
     'Miscellaneous'),
]
