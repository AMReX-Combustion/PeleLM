...
\def\uadv     {U^{\rm ADV}}
\def\uadvstar {U^{{\rm ADV},*}}

\def\phimac     {\phi^{\rm MAC}}
...
\input Preface/PeleLMPreface

%-----------------------------------------------------------------------------
\part{Overview of the \pelelm\ Algorithm}

\chapter{Introduction: Theory and models}
\input Equations/PeleLMEquations

%-----------------------------------------------------------------------------
\part{Using \pelelm}

\chapter{Getting Started}
\input GettingStarted/PeleLMGettingStarted

\chapter{Inputs Files}
\input Inputs/PeleLMInputs.tex

\chapter{Units and Constants}
\input UnitsAndConstants/PeleLMUnits.tex

\chapter{Software Framework}
\input Software/PeleLMSoftware.tex
...
\input Visualization/PeleLMVisualization.tex
