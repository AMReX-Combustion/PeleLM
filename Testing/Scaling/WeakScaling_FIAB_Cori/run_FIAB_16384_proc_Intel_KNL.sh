...
#SBATCH -q debug
#SBATCH -A m2860
#SBATCH -J FIAB_16384_proc_Intel_KNL
#SBATCH -t 00:15:00
#SBATCH -L SCRATCH
#SBATCH -o FIAB_16384_proc_Intel_KNL.%j.out
#SBATCH -S 4
...
INPUTS_DIR=${PWD}
INPUTS="inputs.3d-regt_16384proc"
...
srun -n 16384 -c 4 --cpu-bind=cores /tmp/${EXE} ${INPUTS} ${EXTRA}
