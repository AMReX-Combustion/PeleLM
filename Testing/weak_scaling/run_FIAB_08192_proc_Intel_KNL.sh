...
#SBATCH -q debug
#SBATCH -A m2860
#SBATCH -J FIAB_08192_proc_Intel_KNL
#SBATCH -t 00:10:00
#SBATCH -L SCRATCH
#SBATCH -o FIAB_08192_proc_Intel_KNL.%j.out
#SBATCH -S 4
...
INPUTS_DIR=${EXE_DIR}
INPUTS="inputs.3d-regt_8192proc"
...
srun -n 8192 -c 4 --cpu-bind=cores /tmp/${EXE} ${INPUTS} ${EXTRA}
