  ...
  if(PELELM_ENABLE_CPPCHECK)
    ...
    if(CPPCHECK_EXE)
      ...
      add_custom_target(cppcheck ALL
          ...
          COMMAND ${CPPCHECK_EXE} --template=gcc --inline-suppr --suppress=unusedFunction --suppress=useStlAlgorithm --suppress=unmatchedSuppression --std=c++14 --language=c++ --enable=all --project=cppcheck/cppcheck_compile_commands.json --cppcheck-build-dir=cppcheck/cppcheck-wd -i ${CMAKE_SOURCE_DIR}/../amrex/Src -i ${CMAKE_SOURCE_DIR}/../sundials -i ${CMAKE_SOURCE_DIR}/../IAMR -i ${CMAKE_SOURCE_DIR}/../googletest --output-file=cppcheck/cppcheck-full-report.txt -j ${NP}
